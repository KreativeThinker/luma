      ...
      {!tree.length ? (
        <div className="flex flex-1 flex-col items-center w-full justify-center min-h-screen gap-12 px-4 md:flex-row md:gap-16">
          ...
          <div className="flex flex-col items-start justify-center text-left space-y-4">
            ...
            <h4 className="text-xl md:text-2xl leading-relaxed">Minimal Local Image Viewer</h4>
        ...
        <div className="w-full flex gap-4 relative">
          ...
          {!isDrawerOpen && (
            <button
              ...
              className="fixed left-4 top-4 z-40 p-3 rounded-lg shadow-lg border-2 border-neutral-2 bg-background"
